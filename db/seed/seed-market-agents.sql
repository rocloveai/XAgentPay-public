...
UPDATE merchant_registry SET
  ...
  skill_md_url = 'https://nexus-hotel-agent.onrender.com/skill.md',
  health_url = 'https://nexus-hotel-agent.onrender.com/health',
  mcp_endpoint = 'https://nexus-hotel-agent.onrender.com/sse',
...
UPDATE merchant_registry SET
  ...
  health_url = 'https://nexus-flight-agent.onrender.com/health',
