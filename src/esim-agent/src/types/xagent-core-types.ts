...
/** NUPS Quote Payload — the merchant builds this and sends to XAgentPay Core */
...
// ---------------------------------------------------------------------------
// Webhook payload (received from XAgentPay Core)
// ---------------------------------------------------------------------------
