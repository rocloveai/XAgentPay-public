...
describe("Portal", () => {
  ...
  beforeEach(async () => {
    ...
    await paymentRepo.insert({
      xagent_payment_id: p1.xagent_payment_id,
    ...
    await paymentRepo.insert({
      xagent_payment_id: p2.xagent_payment_id,
    ...
    await paymentRepo.updateStatus(p2.xagent_payment_id, "ESCROWED");
  ...
  describe("GET /api/payments/:id", () => {
    it("returns payment detail with events", async () => {
      ...
      const paymentId = payments[0].xagent_payment_id;
      ...
      expect(data.payment.xagent_payment_id).toBe(paymentId);
