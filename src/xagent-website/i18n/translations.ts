    ...
    market: {
      ...
      list: {
        ...
        form: {
          ...
          sectionBlockchain: "XLayer Wallet",
          sectionOptional: "Advanced Settings",
          showOptional: "Show advanced settings",
          hideOptional: "Hide advanced settings",
          selectCategory: "Select a category...",
          skillMdUrl: "Skill.md URL",
          merchantDid: "Merchant DID (Optional)",
          name: "Agent Name",
          description: "Description",
          category: "Category",
          walletAddress: "Wallet Address (XLayer)",
          healthUrl: "Health Check URL",
          skillUserUrl: "Skill User URL",
          webhookUrl: "Webhook URL",
          webhookSecret: "Webhook Secret",
          walletHint: "Your XLayer Mainnet address for receiving USDC payments and signing quotes. Used for both payment and signature verification.",
          didHint: "Leave empty to auto-generate from your agent name. Format: did:xagent:196:your_id",
          healthHint: "Leave empty to auto-derive from your skill.md URL domain (e.g. /health).",
          placeholders: {
            skillMdUrl: "https://your-agent.com/skill.md",
            merchantDid: "did:xagent:196:your_agent_id",
            name: "My AI Agent",
            description: "Describe what your agent does...",
            walletAddress: "0x... (XLayer Mainnet)",
          ...
          reviewNote: "Your agent will appear on the marketplace once health check passes.",
