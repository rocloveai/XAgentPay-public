...
export const translations = {
  en: {
    ...
    hero: {
      ...
      subtitle: "Stablecoin settlement powered by x402 and ERC-8183 standards. No credit cards, no human intervention — agents pay, verify, and settle autonomously.",
    ...
    monetize: {
      ...
      chat: {
        ...
        log4: "Added Payment Tools — xagent_generate_quote + xagent_check_status",
      ...
      list: {
        ...
        form: {
          ...
          placeholders: {
            ...
            merchantDid: "did:nexus:196:your_agent_id",
            name: "My AI Agent",
          ...
          errors: {
            ...
            invalidDid: "Format: did:nexus:{chain_id}:{id}",
  ...
  zh: {
    ...
    hero: {
      ...
      title1: "AI 代理现在可以",
      title2: "向其他机器付款。",
      subtitle: "基于 x402 和 ERC-8183 标准的稳定币结算。无需信用卡，无需人工干预 — 代理自主支付、验证、结算。",
    ...
    monetize: {
      ...
      chat: {
        ...
        log4: "已添加支付工具 — xagent_generate_quote + xagent_check_status",
      ...
      list: {
        ...
        form: {
          ...
          errors: {
            ...
            invalidDid: "格式：did:nexus:{chain_id}:{id}",
  ...
  ja: {
    ...
    hero: {
      ...
      subtitle: "x402 と ERC-8183 標準に基づくステーブルコイン決済。クレジットカード不要、人間不要 — エージェントが自律的に支払い、検証、決済。",
    ...
    monetize: {
      ...
      chat: {
        ...
        log4: "決済ツールを追加 — xagent_generate_quote + xagent_check_status",
      ...
      list: {
        ...
        form: {
          ...
          errors: {
            ...
            invalidDid: "形式: did:nexus:{chain_id}:{id}",
  ...
  th: {
    ...
    hero: {
      ...
      subtitle: "การชำระเงินด้วย Stablecoin บนมาตรฐาน x402 และ ERC-8183 ไม่ต้องใช้บัตรเครดิต ไม่ต้องใช้คน — เอเยนต์ชำระ ตรวจสอบ และเคลียร์เงินด้วยตนเอง",
    ...
    monetize: {
      ...
      chat: {
        ...
        log4: "เพิ่มเครื่องมือชำระเงินแล้ว — xagent_generate_quote + xagent_check_status",
      ...
      list: {
        ...
        form: {
          ...
          errors: {
            ...
            invalidDid: "รูปแบบ: did:nexus:{chain_id}:{id}",
