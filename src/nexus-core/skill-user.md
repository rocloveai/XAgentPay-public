...
**HTTP:**
```bash
curl -X POST https://nexus-core-361y.onrender.com/api/checkout/tok_.../confirm \
  -H "Content-Type: application/json" \
  -d '{"tx_hash": "0x..."}'
```
...
**HTTP:**
```bash
curl "https://nexus-core-361y.onrender.com/api/payments?group_id=grp_..."
```
...
### MCP (SSE)
```json
{ "mcpServers": { "nexus-core": { "url": "https://nexus-core-361y.onrender.com/sse" } } }
```
