            ...
            <div className="glass-panel p-4 sm:p-8 rounded-xl max-w-lg w-full mx-4 border-t border-l border-white/20 shadow-[0_0_50px_rgba(37,106,244,0.15)]">
              ...
              <div className="flex justify-between items-center mb-4 sm:mb-6 border-b border-white/10 pb-4">
                ...
                <div className="flex items-center gap-2">
                  <span className="material-icons-round text-xs sm:text-sm text-gray-400">
                    verified
                  </span>
                  <span className="text-[10px] sm:text-xs font-mono text-accent-cyan tracking-wider">
                    {t("hero.settled")}
                  </span>
                </div>
              </div>
                ...
                <div className="flex items-center justify-between gap-2">
                  <div className="flex items-center gap-2 sm:gap-3">
                    <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-white/5 flex items-center justify-center border border-white/10 shrink-0">
                      <span className="material-icons-round text-gray-300 text-sm sm:text-base">
                        smart_toy
                      </span>
                    </div>
                  ...
                  <span className="material-icons-round text-gray-600 animate-pulse text-base sm:text-2xl">
                    arrow_forward
                  </span>
