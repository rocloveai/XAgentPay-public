          ...
          <div className="order-2 lg:order-1">
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="text-white font-bold text-lg">
                    {t("infrastructure.aml")}
                  </h4>
                  <p className="text-gray-400 text-sm mt-1">
                    {t("infrastructure.amlDesc")}
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="text-white font-bold text-lg">
                    {t("infrastructure.verification")}
                  </h4>
                  <p className="text-gray-400 text-sm mt-1">
                    {t("infrastructure.verificationDesc")}
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="text-white font-bold text-lg">
                    {t("infrastructure.liquidity")}
                  </h4>
                  <p className="text-gray-400 text-sm mt-1">
                    {t("infrastructure.liquidityDesc")}
                  </p>
                </div>
              </div>
            </div>
                ...
                <div className="glass-card p-3 sm:p-4 rounded-lg flex items-center gap-3 sm:gap-4 bg-background-dark/90 border border-white/20">
                  ...
                  <div className="text-right">
                    <div className="text-white font-mono font-bold text-sm sm:text-base">
                      {t("infrastructure.safe")}
                    </div>
                    <div className="text-[10px] sm:text-xs text-gray-500">
                      {t("infrastructure.authorized")}
                    </div>
                  </div>
                </div>
              </div>
